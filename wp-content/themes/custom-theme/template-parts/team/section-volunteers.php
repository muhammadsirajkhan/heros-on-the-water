 ...
 *
 * ACF group: team_volunteers (see acf-json/group_hotw_team.json).
 *
...
$section = function_exists('get_field') ? get_field('team_volunteers') : null;
if (!is_array($section)) {
    $section = array();
}
...
<section class="hotw-block hotw-team-volunteers-section" aria-labelledby="hotw-volunteers-title">
    <div class="container">
        <header class="hotw-section-head hotw-section-head--center">
            ...
            <?php endif; ?>
            <?php if ($title !== '') : ?>
                <h2 class="hotw-section-title" id="hotw-volunteers-title"><?php echo nl2br(esc_html($title), false); ?></h2>
            <?php endif; ?>
        </header>
