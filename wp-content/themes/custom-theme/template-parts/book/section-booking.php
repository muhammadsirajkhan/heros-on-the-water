...
?>
<section class="oven-section oven-book-table" id="book-table" aria-labelledby="">
    <div class="bg-img">
    ...
    <div class="container py-lg-2">
        ...
        <header class="text-center mb-5">
            <p class="oven-kicker">CLASSIC PIZZAS</p>
            <h2 class="oven-title">Reserve Your <strong>Table Today</strong>
            </h2>
        </header>

        <div class="row justify-content-between g-4 g-lg-5 align-items-start">
            <div class="col-lg-12 col-12">
                <div class="oven-contact-form-card"
                    ...
                    <div class="oven-contact-form-card__inner">
                        ...
                        <div class="oven-contact-form-card__cf7">
                            <?php echo do_shortcode('[contact-form-7 id="de1ffe0" title="Book Form"]'); ?>
...
<section class="oven-section oven-more"
    ...
    <div class="container">
        <div class="row align-items-center justify-content-around g-4 g-lg-5">
            <div class="col-lg-4 col-md-6">
                <p class="oven-kicker">Good food great vibes</p>
                <h2 class="oven-title">More Than
                    Just <strong>Dining</strong>
                </h2>
                <div class="oven-prose mt-4 mb-4">
                    <p>At Black Dog Oven, it’s not just about the food — it’s about the experience.</p>
            ...
            <div class="col-lg-6">
                <div class="oven-vibe-media">
                    <div class="oven-vibe-media__main">
                        <img src="http://localhost/attire-lili/wp-content/themes/custom-theme/assets/images/book/5.png"
...
<section class=" visit-us">
    <div class="container">
        <div class="visit-wrap bg-class"
            ...
            <div class="row">
                <header class="text-center mb-5">
                    <h2 class="oven-title">Find Us And <strong>Visit</strong>
                    </h2>
                </header>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="map">
                            <img src="http://localhost/attire-lili/wp-content/themes/custom-theme/assets/images/book/right-book.png"
                                alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="visit">
                            <img src="http://localhost/attire-lili/wp-content/themes/custom-theme/assets/images/book/left-book.png"
                                alt="">
                        </div>
                    </div>
                </div>
